...
class matching14 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_matching14)
        ...
        buttons = listOf(
            findViewById(R.id.imageButton37),
            findViewById(R.id.imageButton38),
            findViewById(R.id.imageButton39),
            findViewById(R.id.imageButton40),
            findViewById(R.id.imageButton41),
            findViewById(R.id.imageButton42),
            findViewById(R.id.imageButton43),
            findViewById(R.id.imageButton44),
            findViewById(R.id.imageButton46),
            findViewById(R.id.imageButton47),
            findViewById(R.id.imageButton48),
            findViewById(R.id.imageButton51),
            findViewById(R.id.imageButton52),
            findViewById(R.id.imageButton53),
        ...
        findViewById<Button>(R.id.endGame5).setOnClickListener {
